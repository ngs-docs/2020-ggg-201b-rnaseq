...
[This outdated tutorial](https://hbctraining.github.io/DGE_workshop/lessons/04_DGE_DESeq2_analysis.html) is no longer useful in terms of commands, and the algorithm of DESeq2 has changed a bit since this was written, BUT, it has a lot of good description of those algorithm pieces in a bit more detail.
